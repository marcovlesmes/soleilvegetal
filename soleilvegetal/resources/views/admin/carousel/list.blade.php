...
@section('content')
    ...
    <nav class="p-2 my-2 flex justify-end">
        ...
        <a href="{{ route('carousel.set') }}" class="bg-blue-600 text-white py-2 px-4 mx-2 rounded-sm leading-3">Guardar <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="bg-white w-full">
        <form action="{{ route('carousel.set') }}" method="POST">
            ...
            <div class="flex p-2">
                ...
                <a href="{{ route('carousel.destroy', $item->id) }}">
